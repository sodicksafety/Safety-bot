...
app.post("/webhook", (req, res) => {
  ...
  const categories = {
    ...
    friendly: ["คิดถึง", "คิดถึงไหม", "รัก", "รักเราไหม", "ลืมเราหรือยัง", "ตอบเร็วๆ", "อย่าเงียบดิ", "คุยกับเราหน่อย", "เหงา", "เบื่อ", "หิว", "ง่วง"],
  ...
  const replies = {
    ...
    friendly: ["อยู่นี่ครับ ไม่หายไปไหน 🙂", "คิดถึงเหมือนกันครับ", "รักเหมือนกันครับ", "เบื่อเหมือนกันครับ", "หิวเหมือนกันครับ", "เหงาเหมือนกันครับ", "คุยได้เสมอนะครับ", "ไม่ลืมหรอกครับ 🙂"],
  ...
  // Fallback
  return reply(event, "ระบบยังไม่มีข้อมูลคำถามนี้ครับ 🙂");
});
