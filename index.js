...
// --------------------------------------------------
// SAFETY Q&A (รวมทั้งหมดให้ถูกต้อง)
// --------------------------------------------------
const safetyQA = [
  {
...
โรงงาน 2: ข้างโรงขยะ`
  ...
  {
    question: "ที่อยู่",
    answer: `📍 **Sodick (Thailand) – สำนักงานใหญ่**
...
🏭 **โรงงาน 1**  
• เบอร์บริษัท: 02-529-2450 ถึง 6  
• เบอร์ภายใน: 102, 127, 129  

🏭 **โรงงาน 2**  
• เบอร์บริษัท: 02-529-3200 ถึง 6  
• เบอร์ภายใน: 137  

🛡️ **เบอร์มือถือทีมเซฟตี้**

👨‍✈️ **พี่ช้าง (Safety Manager)**  
• 081-376-5583

⛑️ **พี่ไก่ (Safety Factory 1)**  
• 061-645-5095

⛑️ **น้องดุจ (Safety Factory 1)**  
• 081-695-4474

⛑️ **น้องพิน (Safety Factory 2)**  
• 083-237-4357

♻️ **น้องกี้ (Environment)**  
• 094-938-0425`
  }
];
...
client.on("message", async (event) => {
  ...
  await event.reply("Your userId: " + userId);
