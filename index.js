...
const categories = {
  ...
  // หมวดใหม่
  compliment2: [
    "ชมหน่อย", "ให้กำลังใจหน่อย", "ปลอบใจหน่อย", "บอทชมหน่อย",
    "วันนี้เก่งไหม", "ทำดีไหม", "โอเคไหม", "เหนื่อยแต่สู้", "ขอพลังหน่อย"
  ],

  lonely: [
    "เหงามาก", "ไม่มีใครคุยด้วย", "อยู่คนเดียว", "คิดอะไรไม่ออก",
    "เบื่อโลก", "อยากมีเพื่อน", "คุยเป็นเพื่อนหน่อย", "อยู่ไหม", "ตอบหน่อย"
  ],

  fun: [
    "หิวข้าว", "ง่วงมาก", "อยากนอน", "อยากเที่ยว", "เบื่อจัง",
    "คิดอะไรดี", "วันนี้ทำไรดี", "ขี้เกียจ", "ขอฮาหน่อย"
  ],

  misc: [
    "เล่าอะไรหน่อย", "วันนี้เป็นไง", "ถามหน่อย", "คิดถึงไหม",
    "อยากได้กำลังใจ", "เหนื่อยใจ", "ขออะไรดีๆหน่อย", "อยากหัวเราะ", "ช่วยปลอบหน่อย"
  ],

  moodboost: [
    "เหนื่อยจัง", "ท้อแท้", "หมดไฟ", "ขอแรงใจ", "วันนี้ไม่ไหว",
    "ช่วยฮึบหน่อย", "ขอกำลังใจเพิ่ม", "รู้สึกแย่", "วันนี้ไม่โอเค"
  ],

  randomtalk: [
    "คุยเล่นหน่อย", "ว่างไหม", "แกล้งหน่อย", "เล่าเรื่องตลก",
    "ถามอะไรแปลกๆได้ไหม", "คิดถึงเสียงหัวเราะ", "วันนี้มีดราม่าไหม",
    "อยากเม้าท์", "อยากบ่น"
  ],

  cute: [
    "อ้อนหน่อย", "คิดถึงนะ", "กอดหน่อย", "ให้หอมที",
    "ชมหน่อยสิ", "ทำตัวน่ารักหน่อย", "อยากได้ความรัก",
    "อยากได้ความอบอุ่น", "อยากให้ปลอบ"
  ]
};
