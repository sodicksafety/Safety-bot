...
// --------------------------------------------------
if (
  text.includes("ผู้แก้ไขงาน") ||
  text.includes("แก้ไขงาน") ||
  text.includes("ผู้เข้ามาทำงาน")
) {
...
// --------------------------------------------------
if (
  text.includes("ขอบัตรย้อนหลัง") ||
  text.includes("ขอ บัตรย้อนหลัง") ||
  text.includes("บัตรย้อนหลัง")
) {
  return client.replyMessage(event.replyToken, {
    type: "text",
